...
mod Foo {
    #[no_mangle] // Ensure the function is not mangled
    pub extern "Rust" fn my_demo_function(a: u32) -> u32 {
        a
    }

    // Define an alias for `my_demo_function`
    #[no_mangle] // Ensure the function is not mangled
    #[link_name = "my_demo_function"] // Alias `my_demo_function_alias` to `my_demo_function`
